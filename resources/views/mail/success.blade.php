...
<body style="background-color:#E4E6EB;">
  <div style="background-color:#E4E6EB;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#071C4D;">Teman Belajar!</div>
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <div style="background:#salmon;background-color:#ffffff;margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff;background-color:#ffffff;width:100%;">
        <tbody>
          <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:center;color:#071C4D;">Hi,  {{ $data->user->name }}  <br><br>Terimakasih Telah Membeli Kelas ini.<br>Dukungan kalian Sangat berharga Bagi Kami</div>
                            </td>
                          </tr>
                          <tr>
                            <td align="left" style="font-size:0px;padding:20px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071C4D;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:30px;table-layout:auto;width:100%;border:none;">
                                <tr>
                                  <td colspan="3">Detail Transaksi</td>
                                </tr>
                                <tr>
                                  <td><strong>Nama Kelas</strong></td>
                                <td style="text-align: right;">{{ $data->kelas->nama_kelas }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td><strong>Harga Kelas</strong></td>
                                  <td style="text-align: right;">Rp . {{ $data->kelas->harga }}</td>
                                </tr>
                              </table>
                                <img src="{{url($data->kelas->thumbnail)}}" style="margin-top: 50px;" alt="" width="50%">
                            </td>
                          </tr>
                          <tr>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                        <tr>
                          <td style="width: 50px;">
                          <img src="{{url('assets/images/ic_bank.png')}}" width="50px">
                          </td>
                          <td style="font-size: 18px; padding-left: 10px; color: #071C4D;font-family: Assistant, Helvetica, Arial, sans-serif"> support@temanbelajar.id <br> 021-2019-2022 </td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Assistant, Helvetica, Arial, sanf-serif;font-size:18px;line-height:1;text-align:center;color:#888B93;">2020 Teman Belajar Copyright All Rights Reserved.</div>
                    </td>
                  </tr>
                </table>
              </div>
